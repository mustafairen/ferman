...
$limit = "20"; // Bir Sayfada Gösterilecek Kayıt Sayısı  
$kosul = "ORDER BY `log_id` DESC"; //Kayıtları Alma Koşulunuz.. Koşul Yoksa Boş Bırakınız...  
$tabloadi = "log";  
...
<tr>
    ...
    <td align="center" valign="middle"><a href="#" target="_blank" title="<?=$x_oku[log_sistem]?>"><span class="log_renk">İşletim sistemi</span></a>&nbsp;</td>
...
<!-- Tasarım Doğmamış Bebeğe Don Biçmektir. -->

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<form id="form1" name="form1" method="post" action="?shf=blog&islem=duzeltiliyor">
  ...
  <tr>
    <td align="left" valign="top"><div class="gizle">
        <input name="id" type="text"  class="kutu" id="id" value="<?=$oku[blog_id]?>" size="30" readonly=""/></div></td>
  </tr>
  <tr>
    <td align="center" valign="top"><div>
        <table width="500" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" style="background: #FFFFFF;"><textarea name="metin" cols="5" rows="1" id="metin" style="background: #FFFFFF;"><?=$oku[blog_icerik]?>
  </textarea>

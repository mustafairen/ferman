...
?>
<div align="center">
  <h3>Onaysız Yorumlar&nbsp;|&nbsp;<a href="?shf=yorum&islem=oku_onay" target="_self" class="darkgolden"><span class="darkgolden">Onaylı Yorumlar</span></a></h3>
</div>
<?php
...
$kosul = " WHERE yorum_onay='0' ORDER BY `yorum_id` DESC"; //Kayıtları Alma Koşulunuz.. Koşul Yoksa Boş Bırakınız...  
$tabloadi = "yorum";  
...
echo sayfalama($limit,$sayfa,$satir_sayisi,'?shf=yorum&amp;islem=oku_tum');
?>
</div>
	   <?
}else{

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="middle" class="text"><span class="darkgolden">Günlük Ekleme Bölümü</span></td>
  </tr>
  <tr>
    <td align="left" valign="top">
	<form id="form1" name="form1" method="post" action="?shf=blog&islem=ekleniyor">
  ...
  <tr>
	...
	generate_wysiwyg('metin');
              ...
              <tr>
                ...
                <td align="left" valign="top"><input name="postcode" type="password" id="postcode" size="8" maxlength="6" /></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top">&nbsp;</td>
              </tr>

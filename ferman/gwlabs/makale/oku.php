...
<table width="250" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Dökümanlar</td>
    <td><a href="?shf=doc&amp;islem=ekle" class="red">Döküman Ekle</a></td>
  </tr>
</table>
...
$kosul = "ORDER BY `makale_id` DESC"; //Kayýtlarý Alma Koþulunuz.. Koþul Yoksa Boþ Býrakýnýz...  
$tabloadi = "makale";  
  ...
  <?=$oku[makale_id]?>
    ...
    <div class="post">
      ...
      <p class="meta"><span class="darkgolden">
        ...
        <?=$oku[makale_gun]?>
        </span>&nbsp;günü yazýlmýþtýr. @
        <span class="darkgolden">
        <?=$oku[makale_saat]?>
        </span>&nbsp;<a href="?shf=doc&amp;islem=duzelt&amp;id=<?=$oku[makale_id]?>" class="text">Düzenle</a>&nbsp;-&nbsp;<a href="?shf=doc&amp;islem=sil&amp;id=<?=$oku[makale_id]?>">Sil</a></p>
  </div>
</div>
<?
}

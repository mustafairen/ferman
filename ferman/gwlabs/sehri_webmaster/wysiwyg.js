...
// Images Directory
imagesDir = "gwlabs/sehri_webmaster/icons/";

// CSS Directory
cssDir = "gwlabs/sehri_webmaster/styles/";

// Popups Directory
popupsDir = "gwlabs/sehri_webmaster/popups/";
...
var buttonName2 = new Array();
  ...
  buttonName2[12]  = "createlink";
	...
	buttonName2[16] = "unorderedlist";
	buttonName2[17] = "orderedlist";
	buttonName2[18] = "outdent";
	buttonName2[19] = "indent";
	//buttonName2[15]  = "seperator";
  //buttonName2[16]  = "help";
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
	  ...
	  // Add mustafa iren
			...
			//document.write(<hr id="system-readmore">);
	   document.getElementById("wysiwyg" + n).contentWindow.document.execCommand("hr", false, selected);
	  }
		// Every other command
	  else {
